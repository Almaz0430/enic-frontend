        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-white px-4 sm:px-0">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 leading-tight">
              Национальный Центр <br className="hidden sm:block" />
              <span className="text-accent">развития высшего образования</span>
            </h1>
            ...
            <div className="w-full relative">
              ...
              <div className="relative h-[32rem] md:w-3/4 ml-auto overflow-hidden rounded-xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-primary to-transparent">
                    <div className="space-y-6">
                      ...
                      <div className="animate-fade-in-1">
                        ...
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">Ахметов Асан Аманович</h3>
                        <p className="text-white/80 text-base sm:text-lg">Доктор педагогических наук, профессор</p>
                      </div>
                      ...
                      <div className="opacity-0 animate-fade-in-2 absolute inset-x-6 bottom-6">
                        ...
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">Сериков Болат Маратович</h3>
                        <p className="text-white/80 text-base sm:text-lg">Кандидат экономических наук</p>
                      </div>
                      ...
                      <div className="opacity-0 animate-fade-in-3 absolute inset-x-6 bottom-6">
                        ...
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">Алиева Динара Ержановна</h3>
                        <p className="text-white/80 text-base sm:text-lg">Кандидат педагогических наук</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-6 right-6 flex space-x-3 z-20">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-white animate-indicator-1"></div>
                  <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-white/50 animate-indicator-2"></div>
                  <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-white/50 animate-indicator-3"></div>
                </div>
              </div>
            </div>
          </div>
