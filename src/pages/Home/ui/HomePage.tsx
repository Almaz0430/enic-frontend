      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 mt-8">
          <div className="bg-gradient-to-br from-primary/5 to-primary/20 rounded-xl shadow-md p-6 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <h2 className="text-xl font-semibold text-primary mb-3">Признание иностранного образования</h2>
            <p className="text-gray-600 mb-4">Оценка и признание иностранных документов об образовании в соответствии с международными стандартами.</p>
          ...
          <div className="bg-gradient-to-br from-secondary/5 to-secondary/20 rounded-xl shadow-md p-6 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <h2 className="text-xl font-semibold text-secondary mb-3">Профессиональная аккредитация</h2>
            <p className="text-gray-600 mb-4">Независимая оценка качества образовательных программ в соответствии с требованиями рынка труда.</p>
          ...
          <div className="bg-gradient-to-br from-accent/5 to-accent/20 rounded-xl shadow-md p-6 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <h2 className="text-xl font-semibold text-accent mb-3">Болонский процесс</h2>
            <p className="text-gray-600 mb-4">Содействие интеграции российского образования в единое европейское образовательное пространство.</p>
